...
is a comprehensive tool for discovering detailed information about your favorite Pokémon! 🐾🔍 Easily search for Pokémon by name, type, or abilities to access their stats, moves, and evolutions. 📊💪 The app features an intuitive interface with advanced filtering options for a seamless user experience.


## [Live](https://shogof.github.io/Build-a-Pok-mon-Search-App/)

## Demo 📸

![Projecct-Gif](assets/s.png)
...
1. **Clone the repository:**
   ```bash
   git clone git@github.com:shogof/Pokemon-App.git
   ```
...
2.  **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/Shegofa/Pokemon-App.git
    ```
